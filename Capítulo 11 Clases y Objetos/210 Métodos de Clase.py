...
if __name__ == '__main__':
    ...
    #Accedemos al contador persona  desde el objeto persona1
    print(f'Contador objetos Persona (persona1): {persona1.contador_personas}')
    # Accedemos directamente al nombre de la clase para llamar al metodo "get_contador_personas_estatico"
    print(f'Contador objetos Persona (static): {Persona.get_contador_personas_estatico()}')
    # Accedemos directamente al nombre de la clase para llamar al metodo "get_contador_personas_clase"

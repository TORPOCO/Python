...
def inicio():
    ...
    return render_template("357 Campo Id oculto en el Formulario.html", titulo=titulo_app, clientes=clientes_db,
                           forma=cliente_forma)
...
def editar(id):
    ...
    clientes_db = ClienteDAO.seleccionar()
    return render_template('357 Campo Id oculto en el Formulario.html', titulo=titulo_app,
